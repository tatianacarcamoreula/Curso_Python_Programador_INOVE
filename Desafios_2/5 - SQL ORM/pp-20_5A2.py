...
if __name__ == '__main__':
    ...
    # Buscar todas las remeras de talle XL
    query = session.query(Remeras).filter(Remeras.talle == "XL")
    #lo puse dentro de una lista, sino el desafio no me lo tomaba y me aparecía "TypeError: object of type 'int' has no len()"
    remeras = [query.count()]
    print("Remeras XL encontradas:", remeras)
    print("terminamos")
